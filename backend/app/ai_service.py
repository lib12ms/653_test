...
CATEGORY_PROMPTS = {
    ...
    "예술": (
        ...
        "- 금지: XX감상·XX세계·XX사조 형태의 포괄적 상위개념어 전체.\n"
        "  예) 미술감상·그림감상·음악감상·미술사조·예술세계·작품세계\n"
        "  설명·목차에 명시된 구체 사조명·기법명으로만 치환. 추정 금지.\n"
        "  예) 설명에 인상주의 언급 → 허용 / 언급 없으면 → 생성 금지\n"
        "- 예술가명 처리:\n"
        ...
        "     예) 제목에 모네 있고 설명에 인상주의 언급 → 허용 / 언급 없으면 → 생성 금지\n"
    ),
    "교육": (
        "이 책은 교육·외국어 도서입니다.\n"
